...
mik::distance::distance(int port, distance_position position, float x_center_offset, float y_center_offset) : vex::distance(port), port_(port), position_(position), x_center_offset_(x_center_offset), y_center_offset_(y_center_offset), name_(to_sensor_name(position)) {};
...
mik::distance_reset::distance_reset(const std::vector<mik::distance> &distance_sensors) : distance_sensors(distance_sensors) {};
