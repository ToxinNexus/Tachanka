...
std::string red_left_no_middle(bool calibrate, auto_variation var, bool get_name) { 
    ...
    chassis.turn_to_point(-31, 6);
    chassis.drive_to_point(-31, 6);
    assembly.scraper.open();
    chassis.turn_to_point(-31, -24);
    chassis.drive_to_point(-31, -24, {.timeout = 1750, .max_voltage = 6});
    intakecon = 4;
    chassis.drive_to_point(-32.75, 12);
    chassis.turn_to_point(-32.75, 30, {.angle_offset = 180});
    chassis.drive_to_point(-32.75, 30, {.max_voltage = 8});
